...
public class WeatherApp {
    ...
    public static JSONObject getWeatherData(String locationName) {
        ...
        // extract latitude and longtude data
        ...
        String urlString = "https://api.open-meteo.com/v1/forecast?" + 
                "latitude=" + latitude + "&longitude=" + longitued +
                "&hourly=temperature_2m,relativehumidity_2m,weathercode,windspeed_10m&timezone=America%2FLos_Angeles";

        try {
            // call api and get response
            HttpURLConnectionq conn = fetchApiResponse(urlString);
            ...
            // so we need to get the index orf our current hour
    ...
    private static int findIndexOfCurrentTime(JSONArray timeList) {
        ...
        // iterate throught the time list and see which one matches our current time
        for (int i = 0; i < timeList.size(); i++) {
            String tiem = (String) timeList.get(i);
    ...
    private static String getCurrentTime() {
        ...
        LocalDateTime currentDateTiem = LocalDateTime.now();
